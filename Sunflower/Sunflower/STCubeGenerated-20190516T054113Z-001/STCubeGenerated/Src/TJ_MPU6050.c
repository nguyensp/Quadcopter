...
//Library Variable
//1- I2C Handle 
static FMPI2C_HandleTypeDef i2cHandler;
...
//1- i2c Handler 
void MPU6050_Init(FMPI2C_HandleTypeDef *I2Chnd)
{
...
//	HAL_FMPI2C_Master
	...
	HAL_FMPI2C_Master_Receive(&i2cHandler, MPUADDR, i2cBif, NofData, 100);
...
void I2C_Write8(uint8_t ADDR, uint8_t data)
{
	...
	HAL_FMPI2C_Master_Transmit(&i2cHandler, MPUADDR, i2cData, 2,100);
}
